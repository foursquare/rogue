...
on the version of Lift you want to target. In sbt, that would look like the following: 
    ...
    val rogue           = "com.foursquare" %% "rogue-core"          % "2.0.0-beta3" intransitive()
    val rogue           = "com.foursquare" %% "rogue-lift"          % "2.0.0-beta3" intransitive()
...
The latest release is 2.0.0-beta3. See the [changelog](https://github.com/foursquare/rogue/blob/master/CHANGELOG.md) for more details.
