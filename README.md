...
on the version of Lift you want to target. In sbt, that would look like the following: 
    ...
    val rogueField      = "com.foursquare" %% "rogue-field"         % "2.0.0-beta18" intransitive()
    val rogueCore       = "com.foursquare" %% "rogue-core"          % "2.0.0-beta18" intransitive()
    val rogueLift       = "com.foursquare" %% "rogue-lift"          % "2.0.0-beta18" intransitive()
...
The latest release is 2.0.0-beta18. See the [changelog](https://github.com/foursquare/rogue/blob/v2/CHANGELOG.md) for more details.
